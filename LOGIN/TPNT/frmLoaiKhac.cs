...
{
    public partial class frmLoaiKhac : DevExpress.XtraEditors.XtraForm
    {
        public frmLoaiKhac()
        {
            InitializeComponent();
        ...
        private void frmLoaiKhac_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'qL_BAOTANGDataSet.VIEW_KHAC1' table. You can move, or remove it, as needed.
            this.vIEW_KHAC1TableAdapter.Fill(this.qL_BAOTANGDataSet.VIEW_KHAC1);
        ...
        public void saveLoaiRieng(object sender, EventArgs e)
        {
            ...
            {
                // Tạo command để gọi stored procedure
                using (SqlCommand command = new SqlCommand("SP_GHILOAIKHAC_LOAIRIENG", Program.conn))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    ...
                    command.Parameters.AddWithValue("@THELOAI", textTheLoai.Text);
        ...
        public void saveLoaiMuon(object sender, EventArgs e)
        {
            ...
            {
                // Tạo command để gọi stored procedure
                using (SqlCommand command = new SqlCommand("SP_GHILOAIKHAC_LOAIMUON", Program.conn))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public void updateLoaiRieng(object sender, EventArgs e)
        {
            ...
            {
                // Tạo command để gọi stored procedure
                using (SqlCommand command = new SqlCommand("SP_UPDATEKHAC_LOAIRIENG", Program.conn))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public void updateLoaiMuon(object sender, EventArgs e)
        {
            ...
            {
                // Tạo command để gọi stored procedure
                using (SqlCommand command = new SqlCommand("SP_UPDATEKHAC_LOAIMUON", Program.conn))
                {
                    command.CommandType = CommandType.StoredProcedure;
