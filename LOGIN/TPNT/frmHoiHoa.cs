...
{
    public partial class frmHoiHoa : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            // TODO: This line of code loads data into the 'qL_BAOTANGDataSet1.TACGIA' table. You can move, or remove it, as needed.
            this.tACGIATableAdapter.Fill(this.qL_BAOTANGDataSet1.TACGIA);
            // TODO: This line of code loads data into the 'qL_BAOTANGDataSet.VIEW_HOIHOA1' table. You can move, or remove it, as needed.
            this.vIEW_HOIHOA1TableAdapter.Fill(this.qL_BAOTANGDataSet.VIEW_HOIHOA1);
        ...
        public void saveLoaiRieng(object sender, EventArgs e)
        {
            ...
            {
                // Tạo command để gọi stored procedure
                using (SqlCommand command = new SqlCommand("SP_GHIHOIHOA_LOAIRIENG", Program.conn))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    ...
                    command.Parameters.AddWithValue("@TRUONGPHAI", textTruongPhai.Text);
                    command.Parameters.AddWithValue("@VATLIEU", textVatLieu.Text);
                    command.Parameters.AddWithValue("@CHATLIEU", textChatLieu.Text);
        ...
        public void saveLoaiMuon(object sender, EventArgs e)
        {
            ...
            {
                // Tạo command để gọi stored procedure
                using (SqlCommand command = new SqlCommand("SP_GHIHOIHOA_LOAIMUON", Program.conn))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public void updateLoaiRieng(object sender, EventArgs e)
        {
            ...
            {
                // Tạo command để gọi stored procedure
                using (SqlCommand command = new SqlCommand("[SP_UPDATEHOIHOA_LOAIRIENG]", Program.conn))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public void updateLoaiMuon(object sender, EventArgs e)
        {
            ...
            {
                // Tạo command để gọi stored procedure
                using (SqlCommand command = new SqlCommand("SP_UPDATEHOIHOA_LOAIMUON", Program.conn))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        private void textChatLieu_EditValueChanged(object sender, EventArgs e)
        {
